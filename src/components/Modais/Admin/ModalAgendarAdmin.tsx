  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose}>
      <h2 className="text-center text-xl font-semibold text-azulBase mb-5">
        ...
        <InputFieldAuth id="inome" label="Nome do cliente:" type="text" placeholder="Nome" value=""/>
        <InputFieldAuth id="itelefone" label="Telefone:" type="text" placeholder="(xx) xxxxx-xxxx" value=""/>
        <InputFieldAuth id="ivalor" label="Valor pago:" type="text" placeholder="R$0" value="0"/>
